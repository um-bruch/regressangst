...
\textit{Hinweis:} Der Name ``VerordnungsMonitor'' wurde verworfen wegen möglicher Kollisionen mit dem KBV-Begriff ``Verordnungsmonitoring'' und der bestehenden Software-Marke \emph{VerordnungsAmpel} (um-bruch/verordnungsampel). ``Regress-Transparenzportal'' ist und bleibt der Arbeitstitel des Konzepts, bis die Trägerorganisation die finale Namensentscheidung trifft.
