...
% --------------------------------------------------
\subsection{V2a vs. V2b --- die entscheidende Differenzierung (CORE3)}

\textbf{Befund:} Die Einzelfallpr\"ufung (V2) zerf\"allt in zwei Unterkategorien mit fundamental verschiedener Verfahrenslogik:

\begin{itemize}
  \item \textbf{V2a (Unwirtschaftliche Verordnung):} Medizinische Verteidigung m\"oglich. Kostendifferenzmethode begrenzt den Regress auf die Differenz zur wirtschaftlichen Alternative (seit TSVG 2019). Charakter eher vergleichbar mit V1, nur einzelfallbezogen.
  \item \textbf{V2b (Unzul\"assige Verordnung / Formfehler):} Medizinische Gr\"unde irrelevant (normativer Schadensbegriff, BSG B\,6\,KA\,5/09\,R). Keine Kostendifferenzmethode (BSG B\,6\,KA\,5/23\,R, B\,6\,KA\,10/23\,R explizit ausgeschlossen). Keine Heilbarkeit nach Verfahrenseinleitung. Kein Beratungsschutz.
\end{itemize}
...
% --------------------------------------------------
\subsection{Doppelter Zertifikatsfehler (nur V2b in voller Sch\"arfe)}

\textbf{Befund:} Das Regresssystem weist einen doppelten Zertifikatsfehler auf:

\begin{enumerate}
  \item \textbf{Erster Zertifikatsfehler (V1):} Die Auff\"alligkeitspr\"ufung misst Kostenabweichung vom Fachgruppendurchschnitt, nicht medizinische Qualit\"at. F\"ur ein Screening-Verfahren ist das technisch korrekt --- der Fehler liegt in der \"offentlichen Interpretation der niedrigen Regressquote als Beleg f\"ur ein \glqq{}funktionierendes System\grqq{}.
  \item \textbf{Zweiter Zertifikatsfehler (V2, vor allem V2b):} Die Einzelfallpr\"ufung beansprucht, medizinische Unwirtschaftlichkeit zu pr\"ufen. Sie misst faktisch formale und dokumentarische Angreifbarkeit. Formkonformit\"at ist kein Proxy f\"ur medizinische Qualit\"at.
\end{enumerate}

Medizinische Angemessenheit im Sinne des \S\,12 Abs.\,1 SGB\,V wird im deutschen Vertragsarztrecht nur au\ss{}erhalb des Regresssystems zertifiziert (Schlichtungsstellen der \"Arztekammern, zivilrechtliche Arzthaftung).

\textbf{Evidenzbasis:} Systematische Analyse aller Pr\"ufstufen beider Verfahren (Pipeline-Diagramme); BSG-Rechtsprechung; \S\,12 SGB\,V; Goodhart's Law / Campbell's Law als theoretischer Rahmen.

\textbf{Einschr\"ankung:} Der Einwand, das System habe nie ein medizinisches Qualit\"atsversprechen gegeben, ist dogmatisch zutreffend (Einwand 2 der Studie). Der Zertifikatsfehler beschreibt nicht einen Fehler \textit{im} System, sondern die L\"ucke zwischen Systemmessung und \"offentlicher Bedeutungszuschreibung. V1 ber\"ucksichtigt medizinische Besonderheiten im Schutzstufenmodell. V2a l\"asst medizinische Verteidigung zu. Der Befund gilt uneingeschr\"ankt f\"ur V2b.
...
= Regress-Folgekosten (mittleres Szenario, inkl. direkt) & \textbf{0,9--1,7 Mrd. EUR/Jahr} & Eigene Hochrechnung \\
\hline
\end{tabularx}
}
\smallskip
...
% --------------------------------------------------
\subsection{Fehlversorgung bidirektional (Unter- UND \"Uberversorgung)}

\textbf{Befund:} Die deutsche Regressangst erzeugt --- anders als das US-amerikanische Tort Law --- eine Fehlversorgung in zwei Richtungen:

\begin{itemize}
  \item \textbf{Unterversorgung bei Verordnungen:} \"Arzte verschreiben weniger, vermeiden teure Medikamente, verzichten auf Off-Label-Therapien.
...
Der pr\"azisere Begriff ist \textbf{Fehlversorgung}: Das System lenkt \"arztliche Ressourcen von der Therapie (weniger Verordnungen) in die Absicherung (mehr Diagnostik, mehr \"Uberweisungen). Der Nettoverlust liegt beim Patienten: zus\"atzliche Arzttermine, Wartezeiten, Urlaubstage, Anfahrtswege.
...
\begin{itemize}
  \item \textbf{Rang 1 (Halbsatz-Streich):} Eine Zeile Gesetzestext w\"urde die strukturelle Asymmetrie zwischen V1 und V2 beseitigen. Damit g\"alte auch f\"ur Einzelfallpr\"ufungen, dass beim erstmaligen Anlass eine Beratung statt eines Regresses erfolgt. Bereits 2015 in der KBV-Kritik vorgeschlagen.
  \item \textbf{Rang 2 (\S\,48 BMV-\"A):} Der wichtigste existenzvernichtende Regressgrund (491.000\,EUR Stempelregress) lebt au\ss{}erhalb des SGB\,V in einem Kollektivvertrag. Wer \glqq{}nur\grqq{} das Gesetz liest, \"ubersieht ihn. Rein redaktionelle \"Anderung, kein Akteur verliert.
...
\vspace{2mm}
\noindent\textbf{Vollst\"andige Studie:} ST-001 Systemtheoretische Aufarbeitung der Regressangst (Arbeitsversion v0.12, April 2026)\\
\textbf{Begleitstudie zu:} PP-003 Regress-Transparenzportal\\
